...
if $INIT; then
    ...
    rsync -arv -e 'ssh -i ~/.ssh/id_rsa.pub' ${misvm_dir}/workstation/* kado@192.168.1.$WS:/home/kado/machine-learning/workstation/
    exit 1
fi
...
if $REINIT; then
    ...
    rsync -arv -e 'ssh -i ~/.ssh/id_rsa.pub' --delete ${misvm_dir}/bag/joint2img/motempl/*  kado@192.168.1.$WS:/home/kado/machine-learning/bag/joint2img/motempl/
    ...
    rsync -arv -e 'ssh -i ~/.ssh/id_rsa.pub' --delete ${misvm_dir}/workstation/* kado@192.168.1.$WS:/home/kado/machine-learning/workstation
fi
